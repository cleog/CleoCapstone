...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col p-24">
      ...
      <div className="p-8 relative isolate overflow-hidden bg-amber-500 py-32 sm:py-32 text-white flex flex-col">
        <img
       ...
       <div className="flex justify-between">
        <div className="order-1 p-8 items-center">
        {/* <span> */}
